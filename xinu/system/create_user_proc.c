...
void burst_execution(uint32 num_bursts, uint32 burst_duration, uint32 sleep_duration) {
	while(proctab[currpid].num_bursts < num_bursts) {
		proctab[currpid].num_bursts++;
